# REOPEN_B9_N02 OTHER_TIMEFRAME_VALIDATION_EURUSD_M5_FALL_DST_P0 关系入口 v1

## 作用

- 对 `EURUSD / M5 / fall DST` 样本做最小 OR/IB 口径验证。
- 当前只验证 `other timeframe` 可跑性，不写回主 `M1` runtime，不升级成 `failed breakout / retest / reject / day type`。
...
- 当前只新增：
  - `EURUSD/M5 fall DST` validation sample / proof / summary

## 当前真值组成（v1）

- `entry_md`：`REOPEN_B9_N02_OTHER_TIMEFRAME_VALIDATION_EURUSD_M5_FALL_DST_P0_关系入口_v1.md`
- `runtime_notes_md`：`12_工具运行时_TOOLING_RUNTIME\Batch9_reopen_n02_session_or_p0_v1\n02_other_timeframe_validation_eurusd_m5_fall_dst_runtime_notes_v1.md`
...
- 运行入口：
  - `python n02_expand_real_input_with_dst_v1.py --input n02_dst_london_fall_20251023_20251028_bars.csv --input n02_dst_newyork_fall_20251031_20251104_bars.csv --output n02_real_input_eurusd_m5_fall_dst_v1.csv --report-json n02_real_input_eurusd_m5_fall_dst_report_v1.json`
  - `python n02_proof_of_mapping_v2.py --input n02_real_input_eurusd_m5_fall_dst_v1.csv --output n02_proof_of_mapping_output_eurusd_m5_fall_dst_v1.csv`
  - `python n02_ib_proof_of_mapping_v1.py --session-input london=n02_real_input_eurusd_m5_fall_dst_v1.csv --session-input new_york=n02_real_input_eurusd_m5_fall_dst_v1.csv --symbol EURUSD --timeframe M5 --skip-partial-days --output n02_ib_proof_of_mapping_output_eurusd_m5_fall_dst_v1.csv`
