...
- origin_path: D:\Stock\trading_assistant\12_tooling_runtime_archive\batch_09_legacy_analysis_migration__20260707\lifted_trading_analysis\10_来源库_SOURCE_LIBRARY\01_Kimi拆书待入库\GROUP_08_A股量化_数据研究__SOURCE_RAW\新的参考书\《Python股票量化交易从入门到实践》完整版\1.量化策略代码(99份)（赠品）\47 次新小盘策略.txt
...
def check_stocks_initialize():
    ...
    g.filter_st = True
    # 股票池
    g.security_universe_index = ["399101.XSHE","399102.XSHE"]
...
def financial_statements_filter(context, security_list):
    ### _财务指标筛选函数-开始 ###
    security_list = financial_data_filter_xiaoyu(security_list, valuation.circulating_market_cap, 100)
