...
- origin_path: D:\Stock\trading_assistant\12_tooling_runtime_archive\batch_09_legacy_analysis_migration__20260707\lifted_trading_analysis\10_来源库_SOURCE_LIBRARY\01_Kimi拆书待入库\GROUP_08_A股量化_数据研究__SOURCE_RAW\新的参考书\《Python股票量化交易从入门到实践》完整版\1.量化策略代码(99份)（赠品）\88 一位小白编辑的多因子选股策略.txt
...
def financial_statements_filter(context, security_list):
    ...
    security_list = financial_data_filter_dayu(security_list, valuation.market_cap, 100)
