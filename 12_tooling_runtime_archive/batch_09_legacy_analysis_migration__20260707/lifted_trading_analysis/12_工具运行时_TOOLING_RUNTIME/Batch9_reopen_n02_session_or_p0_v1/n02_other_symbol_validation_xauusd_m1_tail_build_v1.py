...
BARS_PATH = REAL_INPUT_DIR / "n02_real_input_xauusd_m1_tail_v1.csv"
OR_PROOF_PATH = REAL_INPUT_DIR / "n02_proof_of_mapping_output_xauusd_m1_tail_v1.csv"
IB_PROOF_PATH = REAL_INPUT_DIR / "n02_ib_proof_of_mapping_output_xauusd_m1_tail_v1.csv"
OUTPUT_MD_PATH = RUNTIME_DIR / "n02_other_symbol_validation_xauusd_m1_tail_summary_v1.md"
OUTPUT_JSON_PATH = RUNTIME_DIR / "n02_other_symbol_validation_xauusd_m1_tail_summary_v1.json"
...
def build_summary(
    ...
    return {
        "producer": "n02_other_symbol_validation_xauusd_m1_tail_build_v1.py",
        "scope": "REOPEN_B9_N02_OTHER_SYMBOL_VALIDATION_XAUUSD_M1_TAIL_P0",
        "status": "fresh_run_validation_summary",
        "evidence_mode": "fresh_run_validation_other_symbol_without_polluting_main_m1_runtime",
        "source_path": {
