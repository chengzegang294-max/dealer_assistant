...
BEYOND_OUTPUT_PATH = RUNTIME_DIR / "n02_ib_or_beyond_multi_session_persistence_observation_p0_sample_v1.csv"
BEYOND_SUMMARY_PATH = RUNTIME_DIR / "n02_ib_or_beyond_multi_session_persistence_observation_p0_summary_v1.json"
NOT_BEYOND_OUTPUT_PATH = RUNTIME_DIR / "n02_ib_or_not_beyond_multi_session_stability_observation_p0_sample_v1.csv"
NOT_BEYOND_SUMMARY_PATH = RUNTIME_DIR / "n02_ib_or_not_beyond_multi_session_stability_observation_p0_summary_v1.json"
...
def build_observation_row(
    ...
    if first_bar is None:
        ...
        status = (
            "second_next_session_first_30m_all_closes_{0}_prior_ib".format(expected)
            if all_expected_bool
            else "second_next_session_first_30m_not_all_closes_{0}_prior_ib".format(expected)
        )
    ...
    return {
        ...
        "observation_scope": "second_next_same_session_first_30m_relative_to_prior_ib",
    }
...
def build_summary(
    ...
    return {
        "producer": "n02_ib_or_multi_session_persistence_and_stability_p0_build_v1.py",
        "scope": scope,
        "status": "fresh_run_second_next_session_first_30m_observation",
        "evidence_mode": "fresh_run_derived_from_next_session_success_rows_and_second_next_session_bars",
        "source_path": {
...
def main() -> None:
    ...
    beyond_rows = build_filtered_rows(
        ...
        bars=bars,
        config=config,
        family="IB_OR_BEYOND_MULTI_SESSION_PERSISTENCE_OBSERVATION",
        expected="beyond",
        id_prefix="IBORBMP",
    )
    not_beyond_rows = build_filtered_rows(
        ...
        bars=bars,
        config=config,
        family="IB_OR_NOT_BEYOND_MULTI_SESSION_STABILITY_OBSERVATION",
        expected="inside",
        id_prefix="IBORNMS",
    )
    ...
    beyond_summary = build_summary(
        scope="REOPEN_B9_N02_IB_OR_BEYOND_MULTI_SESSION_PERSISTENCE_P0",
    ...
    not_beyond_summary = build_summary(
        scope="REOPEN_B9_N02_IB_OR_NOT_BEYOND_MULTI_SESSION_STABILITY_P0",
