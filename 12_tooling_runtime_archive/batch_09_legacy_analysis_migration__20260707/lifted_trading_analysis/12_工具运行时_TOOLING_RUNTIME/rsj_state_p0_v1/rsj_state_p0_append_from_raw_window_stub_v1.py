...
def main() -> None:
    ...
    params = load_params()
    interface = params["raw_window_interface"]
    ...
    print("allow_raw_window_append={0}".format(boundary["allow_raw_window_append"]))
        ...
        "required_fields={0}".format(
            json.dumps(
                [
                    ...
                    interface["rv_up_field"],
                    interface["rv_down_field"],
                ],
                ensure_ascii=True,
            )
        )
