# pv_corr_state_p0_chain_summary_index_v1
...
- 作为 `PV Corr State P0` 历史只读链路的总索引壳。
...
python .\12_tooling_runtime_archive\batch_09_legacy_analysis_migration__20260707\lifted_trading_analysis\12_工具运行时_TOOLING_RUNTIME\pv_corr_state_p0_v1\pv_corr_state_p0_export_chain_summary_index_v1.py
```
...
- `PV Corr State P0` 已具备从最小合同到 `replay chain validation` 的只读证据链总索引。
- 历史上仍不能宣称：
