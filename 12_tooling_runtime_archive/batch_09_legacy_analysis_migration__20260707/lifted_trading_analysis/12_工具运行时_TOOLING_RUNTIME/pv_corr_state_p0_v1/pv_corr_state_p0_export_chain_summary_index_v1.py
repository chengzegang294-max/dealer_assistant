...
from pv_corr_state_p0_runtime_append_stub_v1 import load_params, read_rows as read_runtime_rows
from pv_corr_state_p0_validate_replay_preview_acceptance_v1 import read_preview_rows
...
def main() -> None:
    ...
    stages = [
        ...
        ("bar_window_sample_acceptance", params["bar_window_sample_acceptance_file"]),
        ("bar_window_mapping_acceptance", params["bar_window_mapping_acceptance_file"]),
