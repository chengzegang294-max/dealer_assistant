...
- 当前实际采用的第一份真实 bar 输入：
  - `upstream_samples\n01_first_real_input_bars_v1.csv`
- 推荐顺序：
  1. 先引用本包内已复制的 canonical `n01_first_real_input_bars_v1.csv`
  2. 若未来需要进一步改名，再落本目录自己的 `kd_mtf_p0_first_real_input_bars_v1.csv`
