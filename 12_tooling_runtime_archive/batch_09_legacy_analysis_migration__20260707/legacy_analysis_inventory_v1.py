...
def write_summary(rows: list[Row], root: Path, out_path: Path, do_hash: bool) -> None:
    total_bytes = sum(r.size_bytes for r in rows)
    summary = {
        "format": "legacy_analysis_inventory_v1",
        "root": str(root),
...
def main() -> None:
    ...
    write_summary(rows, root, out_summary, do_hash)
