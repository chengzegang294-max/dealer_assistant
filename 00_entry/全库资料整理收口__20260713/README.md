...
- 本目录集中放置当前“纯资料整理阶段”的 repo-global 台账、拆包规则、参考系统状态，以及必要时正式保留的临时资料评估卡。
- 这样做是为了避免 `00_entry/` 根层继续散放同类整理文档。
- 自 `2026-08-06` 起，本目录中的第一批“历史过程稿”已迁入冻结归档层，不再继续占据当前入口位。
- 当前目录只收：
  - 全库资料整理总台账
  - 最后一轮资料收集拆包路径清单
  - 参考交易系统补齐状态表
...
- 260. `A5_技术指标通用性分析与使用场景细化_多家AI回收记录与主负责人裁决__20260725.md`
- 261. `A5_技术指标第一批场景矩阵_v0页__20260725.md`
- 262. `A5_技术指标缺失判断与补池边界页__20260725.md`
- 263. `A5_技术指标结构性缺位第一轮_仓位层退出层失效方式与外部参考边界页__20260725.md`
- 264. `A5_技术指标仓位层第一轮讨论页__20260725.md`
- 265. `A5_技术指标退出层与失效方式第一轮讨论页__20260725.md`
- 266. `A5_技术指标下一步进入门槛页__多家AI齐全共识规则__20260725.md`
- 267. `A5_技术指标下一步进入条件与外部成熟体系辅助输入判断_多AI前情提要与裁决框架__20260725.md`
- 268. `A5_技术指标下一步进入条件与外部成熟体系辅助输入判断_多家AI正式发包稿__20260725.md`
- 269. `A5_技术指标下一步进入条件与外部成熟体系辅助输入判断_多家AI回收记录模板__20260725.md`
- 270. `A5_技术指标下一步进入条件与外部成熟体系辅助输入判断_OpenWebUI纯文本发包稿__20260725.md`
- 271. `A5_技术指标下一步进入条件与外部成熟体系辅助输入判断_多家AI回收记录与主负责人裁决__20260725.md`
- 272. `A5_技术指标失效方式与波动风险约束第一轮内部分类页__20260725.md`
- 273. `A5_技术指标下一步进入条件复核_第二轮_多AI前情提要与裁决框架__20260725.md`
- 274. `A5_技术指标下一步进入条件复核_第二轮_多家AI正式发包稿__20260725.md`
- 275. `A5_技术指标下一步进入条件复核_第二轮_多家AI回收记录模板__20260725.md`
- 276. `A5_技术指标下一步进入条件复核_第二轮_OpenWebUI纯文本发包稿__20260725.md`
- 277. `A5_技术指标下一步进入条件复核_第二轮_多家AI回收记录与主负责人裁决__20260725.md`
- 278. `A5_技术指标外部成熟体系辅助输入_仓内参考体系优先_多AI前情提要与裁决框架__20260725.md`
- 279. `A5_技术指标外部成熟体系辅助输入_仓内参考体系优先_多家AI正式发包稿__20260725.md`
- 280. `A5_技术指标外部成熟体系辅助输入_仓内参考体系优先_多家AI回收记录模板__20260725.md`
- 281. `A5_技术指标外部成熟体系辅助输入_仓内参考体系优先_OpenWebUI纯文本发包稿__20260725.md`
- 282. `A5_技术指标外部成熟体系辅助输入_仓内参考体系优先_多家AI回收记录与主负责人裁决__20260725.md`
- 283. `A5_技术指标仓内参考体系最小借用组合页__20260725.md`
- 284. `A5_订单流在当前主线中的位置_仓内有无与是否缺失判断页__20260725.md`
- 285. `A5_NFTRADEZ与Smile_SMC最小借用组合映射回五条代表指标_执行框架页__20260725.md`
- 286. `A5_五条代表指标映射草稿页_打板资金__20260725.md`
- 287. `A5_五条代表指标映射草稿页_上榜资金__20260725.md`
- 288. `A5_五条代表指标映射草稿页_HYDB行业对比__20260725.md`
- 289. `A5_五条代表指标映射草稿页_ZSDB指数对比__20260725.md`
- 290. `A5_五条代表指标映射草稿页_沪深涨跌停__20260725.md`
- 291. `A5_五条代表指标第一轮映射汇总页__20260725.md`
- 292. `A5_五条代表指标第一轮映射与矩阵失效页最小借用组合统一回接结论页__20260725.md`
- 293. `A5_技术指标下一步进入条件复核_第三轮_多AI前情提要与裁决框架__20260725.md`
- 294. `A5_技术指标下一步进入条件复核_第三轮_多家AI正式发包稿__20260725.md`
- 295. `A5_技术指标下一步进入条件复核_第三轮_多家AI回收记录模板__20260725.md`
- 296. `A5_技术指标下一步进入条件复核_第三轮_OpenWebUI纯文本发包稿__20260725.md`
- 297. `A5_技术指标下一步进入条件复核_第三轮_回包吸收与主负责人裁决规则页__20260725.md`
- 298. `A5_技术指标下一步进入条件复核_第三轮_多家AI回收记录与主负责人裁决__20260725.md`
- 299. `A5_技术指标仓位层更细粒度升级降级边界第一轮固化页__20260725.md`
- 300. `A5_技术指标下一步进入条件复核_第四轮_多AI前情提要与裁决框架__20260725.md`
- 301. `A5_技术指标下一步进入条件复核_第四轮_多家AI正式发包稿__20260725.md`
- 302. `A5_技术指标下一步进入条件复核_第四轮_多家AI回收记录模板__20260725.md`
- 303. `A5_技术指标下一步进入条件复核_第四轮_OpenWebUI纯文本发包稿__20260725.md`
- 304. `A5_技术指标下一步进入条件复核_第四轮_回包吸收与主负责人裁决规则页__20260725.md`
- 305. `A5_技术指标下一步进入条件复核_第四轮_多家AI回收记录与主负责人裁决__20260725.md`
- 306. `A5_技术指标下一步进入条件复核_第四轮_单模型纠偏补发说明页__20260725.md`
- 307. `A5_技术指标下一步进入条件复核_第四轮_单模型纠偏补发_OpenWebUI纯文本发包稿__20260725.md`
- 308. `A5_技术指标下一步进入条件复核_第四轮_GLM单模型补票说明页__20260725.md`
- 309. `A5_技术指标下一步进入条件复核_第四轮_GLM单模型补票_OpenWebUI纯文本发包稿__20260725.md`
- 310. `A5_五条代表指标职责切换与典型失效样式细化启动页__20260725.md`
- 311. `A5_五条代表指标职责切换与典型失效样式细化_多AI前情提要与裁决框架__20260725.md`
- 312. `A5_五条代表指标职责切换与典型失效样式细化_OpenWebUI纯文本发包稿__20260725.md`
- 313. `A5_五条代表指标职责切换与典型失效样式细化_多家AI回收记录与主负责人裁决__20260727.md`
- 314. `A5_打板资金职责切换与典型失效样式细化页__20260727.md`
- 315. `A5_上榜资金职责切换与典型失效样式细化页__20260727.md`
- 316. `A5_HYDB行业对比职责切换与典型失效样式细化页__20260727.md`
- 317. `A5_ZSDB指数对比职责切换与典型失效样式细化页__20260727.md`
- 318. `A5_沪深涨跌停职责切换与典型失效样式细化页__20260727.md`
- 319. `A5_五条代表指标第二阶段细化汇总与横向对照页__20260727.md`
- 320. `A5_五条代表指标第二阶段统一口径冻结页__20260727.md`
- 321. `A5_五条代表指标失效样式交叉映射补页__20260727.md`
- 322. `A5_五条代表指标多对象联动统一回看模板页__20260727.md`
- 323. `A5_五条代表指标多对象联动样例页__20260727.md`
- 324. `A5_五条代表指标第二阶段阶段性收口页__20260727.md`
- 325. `A5_五条代表指标真实案例采样准备页__20260727.md`
- 326. `A5_五条代表指标真实案例采样最小字段合同页__20260727.md`
- 327. `A5_五条代表指标真实案例采样记录模板页__20260727.md`
- 328. `A5_首批真实案例采样记录起手顺序页__20260727.md`
- 329. `A5_首批真实案例采样仓内证据锚点准备页__20260727.md`
- 330. `A5_首张真实案例采样记录卡时间与来源锚点缺口页__20260727.md`
- 331. `A5_首张真实案例采样记录卡来源桥接页__20260727.md`
- 332. `A5_首张真实案例采样记录卡_source_anchor写法冻结页__20260727.md`
- 333. `A5_首张真实案例采样记录卡预填页__20260727.md`
- 334. `A5_首张真实案例采样记录卡_sample_date候选与排除页__20260727.md`
- 335. `A5_首张真实案例采样记录卡_sample_date确认页__20260727.md`
- 336. `A5_首张真实案例采样记录卡__20260727.md`
- 337. `A5_第二张真实案例采样记录卡__20260727.md`
- 338. `A5_第三张真实案例采样记录卡__20260727.md`
- 339. `A5_首批真实案例采样三卡汇总页__20260727.md`
- 340. `A5_首批真实案例采样阶段性收口页__20260727.md`
- 341. `A5_第四张真实案例采样记录卡__20260727.md`
- 342. `A5_第五张真实案例采样记录卡__20260727.md`
- 343. `A5_第六张真实案例采样记录卡__20260727.md`
- 344. `A5_第二批真实案例采样三卡汇总页__20260727.md`
- 345. `A5_第二批真实案例采样阶段性收口页__20260727.md`
- 346. `A5_六张真实案例采样记录卡总汇总页__20260727.md`
- 347. `A5_六张真实案例采样第一轮矩阵页__20260727.md`
- 348. `A5_真实案例采样第一轮六卡矩阵阶段性总收口页__20260727.md`
- 349. `A5_六张真实案例采样记录卡_occurredAt统一证据合同页__20260727.md`
- 350. `A5_六张真实案例采样记录卡_occurredAt补证汇总页__20260727.md`
- 351. `A5_六张真实案例采样记录卡_单事件精确occurredAt证据边界裁决页__20260727.md`
- 352. `A5_真实案例采样第二轮案例扩展启动页__20260727.md`
- 353. `A5_真实案例采样第二轮案例扩展起手顺序页__20260727.md`
- 354. `A5_真实案例采样第二轮_新日期锚点缺口与证据采集执行卡__20260727.md`
- 355. `A5_技术指标测试主线与信息来源接入裁决页__20260727.md`
- 356. `A5_真实案例采样第二轮_自动抓取边界裁决页__20260727.md`
- 357. `A5_真实案例采样第二轮_最小人工补证清单页__20260727.md`
...
- `A5_五条代表指标职责切换与典型失效样式细化_多家AI回收记录与主负责人裁决__20260727.md`
  - 正式吸收细化阶段首轮多AI回包，并把第一手对象冻结为 `打板资金 -> 上榜资金`，不采用默认的“一触发 + 一背景并行”起手
- `A5_打板资金职责切换与典型失效样式细化页__20260727.md`
  - 把 `打板资金` 从第一轮映射草稿推进到第二阶段细化页，冻结其 `触发层 -> 先降权 -> 回观察位 -> 必要时退出原解释` 的主路径与高频失效样式
- `A5_上榜资金职责切换与典型失效样式细化页__20260727.md`
  - 把 `上榜资金` 从第一轮映射草稿推进到第二阶段细化页，冻结其 `触发层 -> 先降级职责 -> 先降权 -> 必要时回观察位` 的主路径与高频失效样式
- `A5_HYDB行业对比职责切换与典型失效样式细化页__20260727.md`
  - 把 `HYDB行业对比` 从第一轮映射草稿推进到第二阶段细化页，冻结其 `方向层 -> 先降级职责 -> 必要时回观察位 -> 结构破坏时退出原解释` 的主路径与高频失效样式
- `A5_ZSDB指数对比职责切换与典型失效样式细化页__20260727.md`
  - 把 `ZSDB指数对比` 从第一轮映射草稿推进到第二阶段细化页，冻结其 `方向层 -> 先降权 -> 必要时回观察位 -> 极端时退出原解释` 的主路径与高频失效样式
- `A5_沪深涨跌停职责切换与典型失效样式细化页__20260727.md`
  - 把 `沪深涨跌停` 从第一轮映射草稿推进到第二阶段细化页，冻结其 `方向层 -> 先降级职责 -> 必要时回观察位 -> 市场宽度前提被打掉时退出原解释` 的主路径与高频失效样式
- `A5_五条代表指标第二阶段细化汇总与横向对照页__20260727.md`
  - 把五条代表指标第二阶段细化结果收成一张横向总表，统一触发型/背景型对象的主职责、切换路径、失效样式与下一手收束方向
- `A5_五条代表指标第二阶段统一口径冻结页__20260727.md`
  - 把第二阶段细化后的母口径正式冻结，统一触发型/背景型对象的动作升级顺序与后续补页必须挂靠的基础语言
- `A5_五条代表指标失效样式交叉映射补页__20260727.md`
  - 补齐触发型与背景型对象之间的失效样式交叉关系，正式冻结“先看背景怎么坏，再看触发怎么退”的联动解释顺序
- `A5_五条代表指标多对象联动统一回看模板页__20260727.md`
  - 把五条对象进入联动回看时的统一写法正式模板化，固定“先看背景、再看触发、最后决定动作升级”的收口顺序
- `A5_五条代表指标多对象联动样例页__20260727.md`
  - 给联动统一回看模板补了两组正式样例，展示“背景先坏 / 触发后退”与“触发先乱 / 背景也脏”的实际收口写法
- `A5_五条代表指标第二阶段阶段性收口页__20260727.md`
  - 把第二阶段细化到联动模板/样例这一段正式收成停点，并把下一手切到 `真实案例采样（still_need_evidence）`
- `A5_五条代表指标真实案例采样准备页__20260727.md`
  - 把真实案例采样从口头下一手推进成正式准备阶段，冻结采样边界、优先对象与最小产物
- `A5_五条代表指标真实案例采样最小字段合同页__20260727.md`
  - 冻结真实案例采样记录的最小字段合同，统一来源、对象组合、解释字段与 still_need_evidence 字段
- `A5_五条代表指标真实案例采样记录模板页__20260727.md`
  - 提供后续首批真实案例采样记录可直接复用的正式模板，避免再临时重定版式
- `A5_首批真实案例采样记录起手顺序页__20260727.md`
  - 冻结首批真实案例采样记录的起手顺序与先后对象组合，并明确每张记录卡当前仍缺的证据
- `A5_首批真实案例采样仓内证据锚点准备页__20260727.md`
  - 盘清首批真实案例采样当前仓内已具备的对象级证据锚点，并明确真正缺的是单案例时间/来源锚点
- `A5_首张真实案例采样记录卡时间与来源锚点缺口页__20260727.md`
  - 精确冻结首张真实案例采样记录卡当前仍缺的单案例时间与来源锚点，避免把对象级源码/截图链误写成案例级证据
- `A5_首张真实案例采样记录卡来源桥接页__20260727.md`
  - 把首张真实案例采样记录卡当前可用的批次来源链、对象样本链与双证据链正式桥接起来
- `A5_首张真实案例采样记录卡_source_anchor写法冻结页__20260727.md`
  - 正式冻结首张真实案例采样记录卡的 `source_anchor` 分层写法，把缺口压缩到仅剩 `sample_date`
- `A5_首张真实案例采样记录卡预填页__20260727.md`
  - 先把首张真实案例采样记录卡能确定的字段全部预填完成，只把 `sample_date` 保留为唯一待补位
- `A5_首张真实案例采样记录卡_sample_date候选与排除页__20260727.md`
  - 正式冻结 `2026-07-20` 作为首张记录卡的共同时间候选，并明确它当前只能作为候选日期而不是最终事件时间
- `A5_首张真实案例采样记录卡_sample_date确认页__20260727.md`
  - 正式确认首张真实案例采样记录卡的 `sample_date = 2026-07-20`，并把案例日期与精确 `occurredAt` 的证据层级拆开
- `A5_首张真实案例采样记录卡__20260727.md`
  - 正式建立首张真实案例采样记录卡，冻结对象组合、案例日期、来源链与联动解释，同时把精确 `occurredAt` 保持为 `still_need_evidence`
- `A5_第二张真实案例采样记录卡__20260727.md`
  - 正式建立第二张真实案例采样记录卡，冻结 `ZSDB指数对比 / 沪深涨跌停 -> 打板资金` 这一类联动样本
- `A5_第三张真实案例采样记录卡__20260727.md`
  - 正式建立第三张真实案例采样记录卡，冻结 `HYDB行业对比 / ZSDB指数对比 -> 打板资金` 这一类联动样本
- `A5_首批真实案例采样三卡汇总页__20260727.md`
  - 把首批三张正式案例卡收成一个可回看的最小样本包，并统一当前保留的 `still_need_evidence`
- `A5_首批真实案例采样阶段性收口页__20260727.md`
  - 把首批真实案例采样正式收成 `三卡包`，冻结下一段应切到 `精确时刻` 或 `第二批案例`
- `A5_第四张真实案例采样记录卡__20260727.md`
  - 正式建立第四张真实案例采样记录卡，冻结 `HYDB行业对比 / ZSDB指数对比 -> 上榜资金` 这一类联动样本
- `A5_第五张真实案例采样记录卡__20260727.md`
  - 正式建立第五张真实案例采样记录卡，冻结 `ZSDB指数对比 / 沪深涨跌停 -> 上榜资金` 这一类联动样本
- `A5_第六张真实案例采样记录卡__20260727.md`
  - 正式建立第六张真实案例采样记录卡，冻结 `HYDB行业对比 / 沪深涨跌停 -> 打板资金` 这一类联动样本
- `A5_第二批真实案例采样三卡汇总页__20260727.md`
  - 把第二批三张正式案例卡收成一个可回看的第二个三卡包，并补齐首批三卡没覆盖到的关键交叉组合
- `A5_第二批真实案例采样阶段性收口页__20260727.md`
  - 把第二批真实案例采样正式收成第二个 `三卡包`，冻结下一手应切到 `六卡矩阵`
- `A5_六张真实案例采样记录卡总汇总页__20260727.md`
  - 把六张正式案例卡收成一个总汇总页，明确第一轮真实案例采样已形成完整样本矩阵
- `A5_六张真实案例采样第一轮矩阵页__20260727.md`
  - 把六张正式案例卡压成一张 `双背景组合 x 触发对象` 的第一轮矩阵
- `A5_真实案例采样第一轮六卡矩阵阶段性总收口页__20260727.md`
  - 把真实案例采样第一轮正式收成 `六卡矩阵`，冻结下一段应切到 `时刻层补证` 或 `第二轮案例扩展`
- `A5_六张真实案例采样记录卡_occurredAt统一证据合同页__20260727.md`
  - 正式冻结六张案例卡的 `occurredAt` 证据层级，把时间证据统一推进到 `日期粒度 + 运行时窗口粒度`
- `A5_六张真实案例采样记录卡_occurredAt补证汇总页__20260727.md`
  - 把六张正式案例卡在 `occurredAt` 维度上的统一补证结果收成一页，明确剩余缺口仅为单事件精确时刻
- `A5_六张真实案例采样记录卡_单事件精确occurredAt证据边界裁决页__20260727.md`
  - 正式裁决六张案例卡的单事件精确 `occurredAt` 已触到仓内证据边界，防止继续围绕同一时间缺口打转
- `A5_真实案例采样第二轮案例扩展启动页__20260727.md`
  - 正式开启真实案例采样第二轮案例扩展，冻结第二轮不是补老字段，而是引入新日期样本
- `A5_真实案例采样第二轮案例扩展起手顺序页__20260727.md`
  - 冻结第二轮案例扩展的起手顺序：先拿新日期，再做三张最小代表卡，稳住后再考虑扩成完整六卡矩阵
- `A5_真实案例采样第二轮_新日期锚点缺口与证据采集执行卡__20260727.md`
  - 把第二轮案例扩展的唯一关键缺口（新 sample_date）与最小证据标准、采集执行步骤冻结成一页
- `A5_技术指标测试主线与信息来源接入裁决页__20260727.md`
  - 正式裁决工程测试与金融测试的推进关系，并分层定义 A股直播空间、付费A股数据、外汇直播间、连板天梯在 A5 主线里的接入角色与优先级
- `A5_真实案例采样第二轮_自动抓取边界裁决页__20260727.md`
  - 正式裁决第二轮新日期样本的自动抓取已触到外部接口/页面有效载荷边界，防止继续围绕同一组接口空转
- `A5_真实案例采样第二轮_最小人工补证清单页__20260727.md`
  - 把第二轮当前真正需要用户补的最小截图清单冻结成 5 项，避免继续含糊地讨论“还要截什么”
- `A5_真实案例采样第二轮_日期锚点确认页__20260730.md`
  - 正式确认第二轮新 `sample_date=2026-07-29` 已成立，并把主线从“缺新日期”推进到“三张最小代表卡复建”
- `A5_真实案例采样第二轮_页面证据到对象映射与三卡复建边界页__20260730.md`
  - 正式冻结第二轮新日期页面证据已经桥接回哪些 A5 对象，并把当前状态升级为“三卡复建前桥接态”
- `A5_真实案例采样第二轮_HYDB_ZSDB公式壳吸收与三卡分层执行页__20260730.md`
  - 正式确认 HYDB/ZSDB 对象壳已回收入库，并把第二轮三卡推进方式切成“对象壳先齐、同日输入后补卡”的两层执行顺序
- `A5_真实案例采样第二轮_新增截图吸收与候选对象升级页__20260730.md`
  - 正式吸收题材中心、看盘工作台、涨停、炸板四张新增截图，并把打板资金推进到候选输入已入库、HYDB推进到有同日题材背景候选页
- `A5_真实案例采样第二轮_当前步骤目的与信息源关系澄清页__20260730.md`
  - 正式说明当前第二轮这一步的主目标是样本固定，不是做用户信息源大盘点；信息源识别只是必要副产物
- `A5_真实案例采样第二轮_候选上下文页与三卡预复建执行页__20260730.md`
  - 正式确认第二轮已从页面桥接态推进到三卡预复建装配态，但仍不把预复建伪写成正式复建
- `A5_真实案例采样第二轮_HYDB_ZSDB东方财富具体页名候选与最小补图口径页__20260730.md`
  - 正式把 HYDB/ZSDB 的剩余缺口压成东方财富里的具体页名候选，后续若补图优先报具体页名而不是内部对象名
- `A5_第二轮页面级深挖止损与金融测试标准化回主线裁决页__20260730.md`
  - 正式裁决第二轮页面级深挖到此止损，主线切回为金融测试做标准化准备
- `A5_金融测试标准化准备执行页__20260730.md`
  - 正式冻结金融测试标准化准备的执行顺序：最小输入包、字段与降级合同、门槛重排、高价值来源预留口
- `A5_金融测试标准化最小输入包页__20260730.md`
  - 正式冻结金融测试标准化准备阶段的一组样本最小输入包，区分必需页、增强页与可降级项
- `A5_金融测试标准化字段与降级合同页__20260730.md`
  - 正式冻结金融测试标准化准备阶段的字段合同与降级规则，避免候选态对象被伪写成正式真值态
- `A5_工程测试过门槛与金融测试进入门槛重排页__20260730.md`
  - 正式重排工程测试过门槛与金融测试进入门槛，避免把预复建态误写成可直接开金融测试
- `A5_付费A股数据接入预留口页__20260730.md`
  - 正式为付费A股数据预留接入口，明确截图样本链是页面证据层、未来付费数据是正式数据层
- `A5_金融测试标准化验收清单页__20260730.md`
  - 把标准化四件套压成可执行验收清单，并补两日期样本门槛的验收脚手架入口
- `A5_第二日期最小补证页__东方财富PC__20260730.md`
  - 把第二日期最小补证压成东方财富 PC 的 3 张必需图，避免再回到抽象对象名
- `A5_第二日期输入包接入与命名约束页__20260730.md`
  - 冻结第二日期样本接入现有验收链路时的命名、路径与输出规则
- `A5_第二日期输入包接入执行页__20260730.md`
  - 冻结第二日期样本接入现有验收链路的执行顺序：3 张图、计划行、单包验收、两日期门槛重跑
- `A5_第二日期来源批次最小结构模板页__20260730.md`
  - 冻结第二日期样本进入来源库时的最小批次结构：README、provenance、manifest 与 3 张必需截图
- `A5_第二日期批次吸收后最小回填页__20260730.md`
  - 冻结第二日期批次在 3 张图落盘后的最小回填动作：manifest 改 absorbed、生成吸收摘要、再进输入包验收
- `A5_第二日期计划行回填与验收输出命名页__20260730.md`
  - 冻结第二日期样本如何回填 sample plan，以及单输入包验收输出 JSON 的统一命名规则
- `A5_第二日期接入串行执行Runbook页__20260730.md`
  - 冻结第二日期样本一旦到位后的串行执行 runbook：起批次、absorb、计划行、单包验收、两日期门槛、总控摘要
- `A5_第二日期通过后正式页最小回填包页__20260730.md`
  - 冻结第二日期一旦真正通过后，哪些正式页和入口必须最小回填
- `A5_第二日期通过后三张最小代表卡正式复建顺序页__20260730.md`
  - 冻结第二日期一旦通过后，三张最小代表卡按什么顺序正式复建
- `A5_Cursor同步包_金融测试标准化当前目标_已完成_下一步__20260730.md`
  - 给 Cursor 一次性同步当前这轮任务的目标、已完成、停点与下一步，避免继续在截图和脚手架细节上钻深
- `A5_Cursor同步包_信息源优先于第二日期workflow纠偏页__20260730.md`
  - 给 Cursor 补最新纠偏口径：先明确信息源，第二日期 workflow 退回备用执行层
- `A5_信息源分层与优先级冻结页__20260730.md`
  - 正式冻结当前样本源、正式源、增强源、待接入源的分层与优先级，并明确第二日期 workflow 的启用顺序
- `A5_信息源接入执行页__20260730.md`
  - 把信息源分层冻结翻译成可执行接入顺序，并冻结每类来源进入仓内所需的最小输入
- `A5_手头信息源盘点与缺口裁决页__20260730.md`
  - 基于已吸收的手头信息源，正式判断还缺什么、哪些值得付费、哪些适合进入多 AI 讨论
- `A5_信息源多AI讨论前情提要与裁决框架__20260730.md`
  - 给多家 AI 讨论补足前情提要、目标效果、允许推想范围与裁决框架
- `A5_信息源多AI讨论_OpenWebUI纯文本发包稿__20260730.md`
  - 可直接复制到 Open WebUI 的纯文本发包稿，专门讨论正式源优先级、来源分工与付费选择
- `A5_信息源多AI回收记录与主负责人裁决__20260731.md`
  - 吸收第一轮信息源多 AI 回包，并给出正式裁决
- `A5_Tushare权限与字段覆盖审计页__20260731.md`
  - 把 `Tushare` 重新顶回信息源主线第一手，正式审计它的权限层级、字段覆盖与 canonical provider 资格
- `A5_quicktiny_连板天梯历史导出能力核查页__20260731.md`
  - 把 `quicktiny / 连板天梯` 压成信息源第二手，正式核查它是否具备历史回看、导出或多日结构数据能力
- `A5_外界信息处理旧沉淀回收与复用检阅页__20260731.md`
  - 把 `信息直播间 / 金十 / batch149 longhuvip / raw 吸收规则` 等旧沉淀重新捡回，冻结外界信息处理的复用方法
- `A5_信息直播间_金十锚点与旁证回链规则页__20260731.md`
  - 把 `信息直播间 / 金十` 这条外界信息线正式补成可执行规则，并明确历史卡点在锚点缺失与 `金十` 访问阻塞
- `A5_信息直播间第一笔旁证试装页__20260731.md`
  - 用 `萌侠博客` raw 做第一笔正式旁证试装，并确认当前已能试装、但还缺与 `batch150` 同日的硬回链证据
- `A5_batch150同日外界信息补证需求页__20260731.md`
  - 把 `batch150` 当前真正缺的 `2026-07-29` 同日外界信息 raw 压成正式补证清单，优先对齐 `上榜资金 / 市场情绪总览 / 题材中心`
- `A5_batch150跨日解释层参考允许边界页__20260731.md`
  - 提前冻结：若补不到 `2026-07-29` 同日 raw，跨日外界信息最多只能作为解释层软参考，不能冒充硬回链
- `A5_batch150同日外界信息最小补证模板页__20260731.md`
  - 给 `batch150` 的 `2026-07-29` 同日外界信息补证提供统一模板，后续 raw 一到就能直接吸收
- `A5_batch150同日外界信息强制推进执行页__20260731.md`
  - 不再等随机截图，改为先打仓里已有的 `复盘.html / 直播.html` 历史载体；若打不出同日 raw，就立即按软参考边界收口
- `A5_batch149历史载体正式吸收与第三手复用页__20260731.md`
  - 把 `复盘.html / 直播.html / 涨停龙虎.html / 选股宝直播.html` 从 `暂时存放` 正式吸收到 `batch149`，让第三手默认站在归档路径上推进
- `A5_batch149历史载体最短人工验证卡__20260731.md`
  - 若后续需要人工配合，只允许按最短验证卡打开 `复盘.html / 直播.html` 看能否拉到 `2026-07-29`，不再扩成碎操作
- `A5_信息直播间常规化获取与登录阻塞实测页__20260731.md`
  - 已实测确认 `萌侠博客` 主站入口为 `https://mx2025.hhhuu.com/#/`；站点可达，但被 `节点地址为空 + issign=502` 卡在登录前
- `A5_信息直播间登录阻塞纠偏与站内结构待验页__20260731.md`
  - 用户已确认真实环境可登录；当前主线从“登录阻塞”推进到“登录后站内结构待验”
- `A5_信息直播间登录后站内结构初验页__20260731.md`
  - 已确认站内为“左侧多直播间列表 + 右侧正文流 + 历史记录 + 选日期”的静态文本/图片型结构
- `A5_信息直播间常规化获取最小路径页__20260731.md`
  - 已冻结最小路径：保持登录态 -> 选直播间 -> 点历史记录 -> 选日期 -> 摘录文本与图片；当前不按匿名源处理
- `A5_信息直播间第一笔登录态历史摘录样例页__20260731.md`
  - 已用当前登录后截图与口述立住第一笔历史摘录样例，证明“房间列表 -> 历史记录 -> 选日期 -> 正文流”链路可成立
- `A5_信息直播间登录态历史摘录模板页__20260731.md`
  - 后续所有历史摘录统一按“日期、房间、正文摘录、图片证据、A5 角色层”模板入档
- `A5_信息直播间room_anchor与topic_anchor写法冻结页__20260731.md`
  - 已冻结房间锚点与主题锚点的统一写法；当前首笔正式写法为 `小作文嗅嗅+机构研报 / #嗅嗅信息#`
- `A5_信息直播间第一笔正式登录态历史摘录页__20260731.md`
  - 已把 `2026-07-30 22:38:59` 这条半导体板块情绪记录压成第一笔正式登录态历史摘录
- `A5_信息直播间自动获取路径裁决页__20260731.md`
  - 已正式裁决：以后不把人工复制粘贴当默认方式；当前优先走“登录态下半自动获取”，全自动留作后续升级目标
- `A5_Cursor同步包_信息直播间自动获取与登录态采集方案__20260731.md`
  - 已给 Cursor 准备单点任务包，只让它比较半自动/浏览器自动化/RPA 三条实现路线
- `A5_信息源主线连续推进口令页__20260731.md`
  - 给当前信息源主线提供一条可直接复制的连续推进口令，避免每轮重新下碎指令
- `A5_信息源第二轮多AI讨论前情提要与裁决框架__20260731.md`
  - 在第一轮结论基础上，新增讨论 `Pi 是否适合作为 AI 角色` 与 `是否适合训练用户能力`
- `A5_信息源第二轮多AI讨论_OpenWebUI纯文本发包稿__20260731.md`
  - 可直接发起第二轮多 AI 讨论的纯文本发包稿
- `A5_信息源第二轮多AI回收记录与主负责人裁决__20260731.md`
  - 吸收第二轮多 AI 回包，并正式冻结 `Pi` 只做陪练/解释/复盘辅助位，以及“训练用户能力”只挂真实任务复盘
- `A5_Pi接入方式与长期可用性审计页__20260731.md`
  - 正式审计 `Pi` 是否具备稳定、低摩擦、可长期使用的接入方式，并明确它不覆盖信息源主线
- `A5_Pi角色最小合同页__20260731.md`
  - 正式冻结 `Pi` 的最小角色边界：只做陪练/解释/复盘辅助位，不做编程、裁决与执行
...
- `A5_信息直播间档案建档与列表哨兵动态抓取裁决页__20260807.md`
  - 冻结直播间建档（沉底/换人/新增）与动态抓取分层：列表哨兵+置顶深挖；含 Cursor/Trae 互通口径
- `A5_信息直播间文字抓取与核心留存优化页__20260807.md`
  - 四房证据驱动的 v1.5/v1.3 文字核心与抗混标签优化及复跑进度
