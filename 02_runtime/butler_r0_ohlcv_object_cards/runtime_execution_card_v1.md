...
- 用 `run_registry_v0_batch_acceptance_v1.py` 对 `minimal_registry_ready + multi_registry_ready` 样本批量执行 `registry runner + 强验收`，当前已覆盖 `601991 blocked`、`300302 自代理`、`300302/601991 分离代理`、`301666/601991`、`300750 自代理`、`300750/601991 分离代理` 六条样本，并同步输出 JSON/TSV 摘要。
