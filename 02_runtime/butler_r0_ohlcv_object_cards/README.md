...
- `GENERATOR`:
  ...
  - `run_registry_v0_batch_acceptance_v1.py`
...
- `run_registry_v0_batch_acceptance_v1.py` 已把 `registry_v0` 从单样本验收推进到多样本批量验收，当前 5 条 `multi_registry_ready` 样本已全部 `pass`，已覆盖 `BUY/ALLOW` 与 `SELL/EXIT` 的自代理/分离代理差异。
